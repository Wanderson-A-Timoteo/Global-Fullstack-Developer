...
def trabalhando_com_datetime():
    ...
    print(data_atual)
    print(data_atual_str.strftime('%d/%m/%Y %H:%M:%S'))
    ...
    tupla = ('Segunda-Feirra', 'Terça-Feira', 'Quarta-Feira', 'Quinta-Feira', 'Sexta-Feira', 'Sábado', 'Domingo')
    print(tupla[data_atual.weekday()])
    data_criada = datetime(2020, 6, 27, 16, 30, 20)
    print(data_criada)
